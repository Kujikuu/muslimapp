...
class _LoginScreenState extends State<LoginScreen> {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                          colors: [Color(0x22D83AFF), Color(0x22E049FE)])),
                ),
              ),
              ClipPath(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                          colors: [Color(0x44B740CF), Color(0x44C549FE)])),
                ),
              ),
              ClipPath(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                          colors: [Color(0xFF750B96), Color(0xFF8034A3)])),
                ),
              ),
            ],
          ),
  ...
  _loginBtn() async {
    AuthResult result = await FirebaseAuth.instance.signInWithEmailAndPassword(
        email: mail_controller.text, password: pass_controller.text);
    ...
    if (result.user != null) {
      ...
      setState(() {
        // _error = 'UserRegisteration Error!';
        // _isLoading = false;
      });
    }
  }

  void _loginAnynmouseBtn() async {
